const PRODUCT_ICONS = {
 damla: '<svg viewBox="0 0 64 64" fill="none" xmlns="http:
 yagmurlama: '<svg viewBox="0 0 64 64" fill="none" xmlns="http:
 pompa: '<svg viewBox="0 0 64 64" fill="none" xmlns="http:
 filtre: '<svg viewBox="0 0 64 64" fill="none" xmlns="http:
 boru: '<svg viewBox="0 0 64 64" fill="none" xmlns="http:
 akilli: '<svg viewBox="0 0 64 64" fill="none" xmlns="http:
};
